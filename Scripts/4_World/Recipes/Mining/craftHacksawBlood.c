class craftHacksawBlood extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft BloodHacksaw";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_Blood");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Hacksaw_Blood");//add results here
