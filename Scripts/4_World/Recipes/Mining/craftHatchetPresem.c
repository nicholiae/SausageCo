class craftHatchetPresem extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft PresemHatchet";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2.00;//animation length in relative time units
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_Presem");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageAnvil");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageAnvil_Static");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Hatchet_Presem");//add results here
	...
	// result2
		// AddResult("SausageCo_Experience_Firearm");//add results here
