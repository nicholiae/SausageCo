class craftHacksawRune extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft RuneHacksaw";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_Rune");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Hacksaw_Rune");//add results here
