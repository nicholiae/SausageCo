class craftPickaxeJade extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft JadePickaxe";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_Jade");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Pickaxe_Jade");//add results here
