class createGunPowder6 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 400%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_Presem");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_GunPowder");//add results here

		m_ResultSetFullQuantity[0] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[0] = 800;//-1 = do nothing
	...
	// result2
		...
		m_ResultSetQuantity[1] = 30;//-1 = do nothing
