class upgradeTier1Hunter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Hunter Journeyman";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_HuntersToolT1");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_HuntersToolT2");//add results here
