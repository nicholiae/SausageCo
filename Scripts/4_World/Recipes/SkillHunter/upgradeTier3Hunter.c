class upgradeTier3Hunter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Hunter GrandMaster";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Hunter");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_HuntersToolT3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_HuntersToolT4");//add results here
