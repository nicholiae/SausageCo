class upgradeTier2Hunter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Hunter Master";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_HuntersToolT2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_HuntersToolT3");//add results here
