class craftBoneLure extends RecipeBase
{	
	override void Init()
	{
		m_Name = "craft bone lure";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_HuntersTool");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_BoneLure");//add results here
