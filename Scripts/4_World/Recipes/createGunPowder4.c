class createGunPowder4 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 200%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_Jade");//you can insert multiple ingredients this way
	...
	// result2
		...
		m_ResultSetQuantity[1] = 18;//-1 = do nothing
