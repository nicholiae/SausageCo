class createGunPowder1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 50%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_copper");//you can insert multiple ingredients this way
