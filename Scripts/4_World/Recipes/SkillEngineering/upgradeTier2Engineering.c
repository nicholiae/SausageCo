class upgradeTier2Engineering extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Engineering Master";
		...
		m_MinQuantityIngredient[0] = 1500;//-1 = disable check
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Engineer");//you can insert multiple ingredients this way
		
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = -1500;// 0 = do nothing
		m_IngredientDestroy[0] = false;//true = destroy, false = do nothing
		m_IngredientUseSoftSkills[0] = false;// set 'true' to allow modification of the values by softskills on this ingredient
		
		//ingredient 2
		InsertIngredient(1,"SausageCo_EngineersToolT2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_EngineersToolT3");//add results here
