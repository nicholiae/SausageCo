class createKitchenStove extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Kitchen Stove -115";
		...
		//result1
		AddResult("SausageKitchen_Stove_Kit");//add results here
		...
		m_ResultSetQuantity[1] = 23;//-1 = do nothing
