class upgradeTier1Engineering extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Engineering Artisan";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_EngineersToolT1");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_EngineersToolT2");//add results here
