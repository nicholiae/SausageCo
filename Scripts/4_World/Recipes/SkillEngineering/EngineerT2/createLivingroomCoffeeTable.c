class createLivingroomCoffeeTable extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Livingroom CoffeeTable -30";
		...
		//result1
		AddResult("SausageLivingroom_CoffeeTable_Kit");//add results here
