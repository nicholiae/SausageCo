class createBathroomSink extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Bathroom Sink -45";
		...
		m_MinQuantityIngredient[0] = 45;//-1 = disable check
		...
		m_IngredientAddQuantity[0] = -45;// 0 = do nothing
		...
		//result1
		AddResult("SausageBathroom_Sink_Kit");//add results here
