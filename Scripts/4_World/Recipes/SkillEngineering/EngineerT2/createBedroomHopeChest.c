class createBedroomHopeChest extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Bedroom Hopechest -120";
		...
		m_MinQuantityIngredient[0] = 120;//-1 = disable check
		...
		m_IngredientAddQuantity[0] = -120;// 0 = do nothing
		...
		//result1
		AddResult("SausageBedroom_Hopechest_Kit");//add results here
		...
		//result2
		AddResult("SausageCo_Experience_Engineer");//add results here

		m_ResultSetFullQuantity[1] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[1] = 100;//-1 = do nothing
