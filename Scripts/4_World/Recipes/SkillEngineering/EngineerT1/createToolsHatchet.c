class createToolsHatchet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Tools Hatchet -36";
		...
		m_MinQuantityIngredient[0] = 36;//-1 = disable check
		...
		m_IngredientAddQuantity[0] = -36;// 0 = do nothing
