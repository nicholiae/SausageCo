class createSC_Cannabis_SourDiesel_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create SourDiesel SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_SourDiesel_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_SourDiesel_CannabisSeedsPack");//add results here
