class createSC_KiwiSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Kiwi SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_KiwiSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_KiwiSeedsPack");//add results here
