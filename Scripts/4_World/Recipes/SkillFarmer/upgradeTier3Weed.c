class upgradeTier3Weed extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade to T4 Weed Skill";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Farmer");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT3Weed");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FarmersToolT4Weed");//add results here
