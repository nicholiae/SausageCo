class createSC_SambucusBerrySeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create SambucusBerry SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_SambucusBerrySeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_SambucusBerrySeedsPack");//add results here
