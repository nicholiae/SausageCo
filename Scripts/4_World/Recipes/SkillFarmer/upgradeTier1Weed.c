class upgradeTier1Weed extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade to T2 Weed Skill";
		...
		m_MinQuantityIngredient[0] = 600;//-1 = disable check
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT1Weed");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FarmersToolT2Weed");//add results here
