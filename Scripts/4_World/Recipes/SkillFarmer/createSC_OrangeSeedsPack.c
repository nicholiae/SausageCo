class createSC_OrangeSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Orange SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_OrangeSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_OrangeSeedsPack");//add results here
