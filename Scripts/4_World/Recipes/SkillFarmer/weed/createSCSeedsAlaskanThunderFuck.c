class createSCSeedsAlaskanThunderFuck extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Seeds AlaskanThunderFuck";
		...
		//result1
		AddResult("SC_Cannabis_Alaskan_ThunderFuck_Seeds");//add results here
