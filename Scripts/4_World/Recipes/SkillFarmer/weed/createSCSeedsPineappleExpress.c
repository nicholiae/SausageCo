class createSCSeedsPineappleExpress extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Seeds PineappleExpress";
		...
		//result1
		AddResult("SC_Cannabis_PineappleExpress_Seeds");//add results here
