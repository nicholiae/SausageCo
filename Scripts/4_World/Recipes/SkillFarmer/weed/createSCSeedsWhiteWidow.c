class createSCSeedsWhiteWidow extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Seeds WhiteWidow";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT4Weed");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Cannabis_WhiteWidow_Seeds");//add results here
