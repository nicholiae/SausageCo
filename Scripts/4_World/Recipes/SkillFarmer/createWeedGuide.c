class createWeedGuide extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Begin your Weed Skill";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT4");//you can insert multiple ingredients this way
