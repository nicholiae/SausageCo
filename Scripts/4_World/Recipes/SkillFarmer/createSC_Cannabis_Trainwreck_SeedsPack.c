class createSC_Cannabis_Trainwreck_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create TrainWreck SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_Trainwreck_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Trainwreck_CannabisSeedsPack");//add results here
