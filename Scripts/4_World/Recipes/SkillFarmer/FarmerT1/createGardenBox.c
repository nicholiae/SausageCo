class createGardenBox extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create GardenBox -20";
		...
		//result1
		AddResult("SausageCo_EmptyGardenBox");//add results here
		...
		m_ResultSetQuantity[1] = 80;//-1 = do nothing
