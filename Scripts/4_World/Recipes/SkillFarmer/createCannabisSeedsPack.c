class createCannabisSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Cannabis SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"CannabisSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CannabisSeedsPack");//add results here
