class createSC_PotatoSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Potato SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_PotatoSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_PotatoSeedsPack");//add results here
