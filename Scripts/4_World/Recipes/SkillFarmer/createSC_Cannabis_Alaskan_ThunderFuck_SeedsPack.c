class createSC_Cannabis_Alaskan_ThunderFuck_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create AlaskanThunderFuck SeedsPack";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SC_EmptySeedsPack");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_Alaskan_ThunderFuck_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Alaskan_ThunderFuck_CannabisSeedsPack");//add results here
