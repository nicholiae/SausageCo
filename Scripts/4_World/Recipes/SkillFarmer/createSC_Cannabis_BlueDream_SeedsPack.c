class createSC_Cannabis_BlueDream_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create BlueDream SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_BlueDream_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_BlueDream_CannabisSeedsPack");//add results here
