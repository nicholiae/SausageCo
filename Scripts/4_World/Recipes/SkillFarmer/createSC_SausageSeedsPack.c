class createSC_SausageSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Sausage SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_SausageSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_SausageSeedsPack");//add results here
