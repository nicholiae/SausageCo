class createSC_PearSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Pear SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_PearSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_PearSeedsPack");//add results here
