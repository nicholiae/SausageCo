class createSC_AppleSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Apple SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_AppleSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_AppleSeedsPack");//add results here
