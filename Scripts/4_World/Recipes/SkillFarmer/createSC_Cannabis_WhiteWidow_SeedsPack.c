class createSC_Cannabis_WhiteWidow_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create WhiteWidow SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_WhiteWidow_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_WhiteWidow_CannabisSeedsPack");//add results here
