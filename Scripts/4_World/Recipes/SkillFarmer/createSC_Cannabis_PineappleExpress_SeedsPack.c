class createSC_Cannabis_PineappleExpress_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create PineappleExpress SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_PineappleExpress_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_PineappleExpress_CannabisSeedsPack");//add results here
