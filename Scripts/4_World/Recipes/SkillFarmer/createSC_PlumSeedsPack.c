class createSC_PlumSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Plum SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_PlumSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_PlumSeedsPack");//add results here
