class upgradeTier2Farmer extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Farmer Master";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FarmersToolT3");//add results here
