class upgradeTier3Farmer extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Farmer Mastery";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FarmersToolT4");//add results here
