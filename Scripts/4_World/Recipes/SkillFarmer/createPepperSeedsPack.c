class createPepperSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Pepper SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"PepperSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PepperSeedsPack");//add results here
