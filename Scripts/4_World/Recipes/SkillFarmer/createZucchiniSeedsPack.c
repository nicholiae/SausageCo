class createZucchiniSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Zucchini SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"ZucchiniSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ZucchiniSeedsPack");//add results here
