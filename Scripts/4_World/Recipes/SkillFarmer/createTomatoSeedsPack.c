class createTomatoSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Tomato SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"TomatoSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TomatoSeedsPack");//add results here
