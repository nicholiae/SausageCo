class createSC_CaninaBerrySeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create CaninaBerry SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_CaninaBerrySeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_CaninaBerrySeedsPack");//add results here
