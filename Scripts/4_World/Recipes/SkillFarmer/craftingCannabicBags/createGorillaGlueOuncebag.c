class createGorillaGlueOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"GorillaGlueHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"GorillaGlueHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("GorillaGlueOuncebag");//add results here
