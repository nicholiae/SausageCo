class createGorillaGluePoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"GorillaGlueOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("GorillaGluePoundbag");//add results here
