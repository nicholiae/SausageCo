class createFireCrotchOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"FireCrotchHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"FireCrotchHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FireCrotchOuncebag");//add results here
