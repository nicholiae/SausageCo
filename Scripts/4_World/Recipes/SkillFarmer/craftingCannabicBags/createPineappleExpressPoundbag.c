class createPineappleExpressPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"PineappleExpressOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PineappleExpressPoundbag");//add results here
