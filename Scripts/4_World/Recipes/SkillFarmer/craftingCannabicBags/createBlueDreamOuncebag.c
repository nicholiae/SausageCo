class createBlueDreamOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BlueDreamHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"BlueDreamHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BlueDreamOuncebag");//add results here
