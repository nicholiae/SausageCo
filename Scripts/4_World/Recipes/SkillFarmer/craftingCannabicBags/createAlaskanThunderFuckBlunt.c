class createAlaskanThunderFuckBlunt extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll Blunt";
		...
		//ingredient 2
		InsertIngredient(1,"SC_BluntWraps");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Blunt_ATF");//add results here
