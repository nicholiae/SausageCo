class createSourDieselPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SourDieselOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SourDieselPoundbag");//add results here
