class createPineappleExpressHalfOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SC_Cannabis_PineappleExpress");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_PineappleExpress");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PineappleExpressHalfOuncebag");//add results here
