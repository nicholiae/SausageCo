class createWhiteWidowOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"WhiteWidowHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"WhiteWidowHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WhiteWidowOuncebag");//add results here
