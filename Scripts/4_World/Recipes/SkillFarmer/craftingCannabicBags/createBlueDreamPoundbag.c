class createBlueDreamPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BlueDreamOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BlueDreamPoundbag");//add results here
