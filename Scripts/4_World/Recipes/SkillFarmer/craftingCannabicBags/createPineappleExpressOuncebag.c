class createPineappleExpressOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"PineappleExpressHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"PineappleExpressHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PineappleExpressOuncebag");//add results here
