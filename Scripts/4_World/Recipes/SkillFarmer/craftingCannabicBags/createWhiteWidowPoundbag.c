class createWhiteWidowPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"WhiteWidowOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WhiteWidowPoundbag");//add results here
