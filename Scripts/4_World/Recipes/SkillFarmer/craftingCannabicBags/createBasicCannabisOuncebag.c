class createBasicCannabisOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BasicCannabisHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"BasicCannabisHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BasicCannabisOuncebag");//add results here
