class createTrainwreckOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TrainwreckHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"TrainwreckHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TrainwreckOuncebag");//add results here
