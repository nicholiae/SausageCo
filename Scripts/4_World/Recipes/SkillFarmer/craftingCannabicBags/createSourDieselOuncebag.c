class createSourDieselOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SourDieselHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SourDieselHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SourDieselOuncebag");//add results here
