class createAlaskanThunderFuckPoundbag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Pound Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"AlaskanThunderFuckOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AlaskanThunderFuckPoundbag");//add results here
