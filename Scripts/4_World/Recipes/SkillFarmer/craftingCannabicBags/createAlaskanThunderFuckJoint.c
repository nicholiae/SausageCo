class createAlaskanThunderFuckJoint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Joint";
		...
		//ingredient 2
		InsertIngredient(1,"SC_RollingPapers");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_Joint_ATF");//add results here
