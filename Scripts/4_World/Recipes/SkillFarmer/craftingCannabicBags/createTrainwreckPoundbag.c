class createTrainwreckPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TrainwreckOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TrainwreckPoundbag");//add results here
