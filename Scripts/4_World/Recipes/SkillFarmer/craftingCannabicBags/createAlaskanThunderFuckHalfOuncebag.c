class createAlaskanThunderFuckHalfOuncebag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Half-Ounce Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SC_Cannabis_Alaskan_ThunderFuck");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_Alaskan_ThunderFuck");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AlaskanThunderFuckHalfOuncebag");//add results here
		...
		// result2
		// AddResult("SausageCo_Experience_Farmer");//add results here
