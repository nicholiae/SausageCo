class createWhiteWidowHalfOuncebag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SC_Cannabis_WhiteWidow");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_WhiteWidow");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WhiteWidowHalfOuncebag");//add results here
