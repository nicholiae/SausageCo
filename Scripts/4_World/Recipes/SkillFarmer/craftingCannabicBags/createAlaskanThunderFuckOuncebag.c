class createAlaskanThunderFuckOuncebag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Ounce Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"AlaskanThunderFuckHalfOuncebag");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"AlaskanThunderFuckHalfOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AlaskanThunderFuckOuncebag");//add results here
