class createBasicCannabisPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BasicCannabisOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BasicCannabisPoundbag");//add results here
