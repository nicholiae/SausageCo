class createFireCrotchPoundbag extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"FireCrotchOuncebag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FireCrotchPoundbag");//add results here
