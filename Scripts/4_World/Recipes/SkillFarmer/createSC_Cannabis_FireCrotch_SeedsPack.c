class createSC_Cannabis_FireCrotch_SeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create FireCrotch SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Cannabis_FireCrotch_Seeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_FireCrotch_CannabisSeedsPack");//add results here
