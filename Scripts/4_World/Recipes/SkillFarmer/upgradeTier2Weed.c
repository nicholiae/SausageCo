class upgradeTier2Weed extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade to T3 Weed Skill";
		...
		m_MinQuantityIngredient[0] = 900;//-1 = disable check
		...
		m_IngredientAddQuantity[0] = -900;// 0 = do nothing
		m_IngredientDestroy[0] = false;//true = destroy, false = do nothing
		m_IngredientUseSoftSkills[0] = false;// set 'true' to allow modification of the values by softskills on this ingredient
		
		//ingredient 2
		InsertIngredient(1,"SausageCo_FarmersToolT2Weed");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FarmersToolT3Weed");//add results here
