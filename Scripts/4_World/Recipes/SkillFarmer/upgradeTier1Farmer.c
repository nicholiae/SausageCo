class upgradeTier1Farmer extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Farmer Artisan";
		...
		//result1
		AddResult("SausageCo_FarmersToolT2");//add results here
		...
		// result2
		AddResult("SausageCo_FarmersToolT1Weed");//add results here
