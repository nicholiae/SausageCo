class createSC_BananaSeedsPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Banana SeedsPack";
		...
		//ingredient 2
		InsertIngredient(1,"SC_BananaSeeds");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_BananaSeedsPack");//add results here
