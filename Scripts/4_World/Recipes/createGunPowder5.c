class createGunPowder5 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 300%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_Rune");//you can insert multiple ingredients this way
	...
	// result2
		...
		m_ResultSetQuantity[1] = 24;//-1 = do nothing
