class CombineGunPowder2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Combine Gunpowder 25+25";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_GunPowder");//you can insert multiple ingredients this way
