class createZestApple extends RecipeBase
{	
	override void Init()
	{
		m_Name = "create Zest Apple";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Apple");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_ZestApple");//add results here
