class RepairWithChefSkill extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#repair";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_ChefsTool");//you can insert multiple ingredients this way
		...
		InsertIngredient(1,"FryingPan");//you can insert multiple ingredients this way
