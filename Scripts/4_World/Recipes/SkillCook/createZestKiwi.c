class createZestKiwi extends RecipeBase
{	
	override void Init()
	{
		m_Name = "create Zest Kiwi";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Kiwi");//you can insert multiple ingredients this way
		InsertIngredient(1,"Kiwi");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_ZestKiwi");//add results here
