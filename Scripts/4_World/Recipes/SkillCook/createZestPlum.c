class createZestPlum extends RecipeBase
{	
	override void Init()
	{
		m_Name = "create Zest Plum";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Plum");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_ZestPlum");//add results here
