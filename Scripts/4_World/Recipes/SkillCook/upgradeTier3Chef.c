class upgradeTier3Chef extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Chef GrandMaster";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Cook");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_ChefsToolT3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_ChefsToolT4");//add results here
