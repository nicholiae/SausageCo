class createZestBanana extends RecipeBase
{	
	override void Init()
	{
		m_Name = "create Zest Banana";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Banana");//you can insert multiple ingredients this way
		InsertIngredient(1,"Banana");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_ZestBanana");//add results here
