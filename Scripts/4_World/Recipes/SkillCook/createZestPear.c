class createZestPear extends RecipeBase
{	
	override void Init()
	{
		m_Name = "create Zest Pear";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Pear");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_ZestPear");//add results here
