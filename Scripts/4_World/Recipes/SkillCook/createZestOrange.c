class createZestOrange extends RecipeBase
{	
	override void Init()
	{
		m_Name = "create Zest Orange";
		...
		//ingredient 2
		InsertIngredient(1,"SC_Orange");//you can insert multiple ingredients this way
		InsertIngredient(1,"Orange");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_ZestOrange");//add results here
