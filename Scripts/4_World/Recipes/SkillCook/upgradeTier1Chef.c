class upgradeTier1Chef extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Chef Journeyman";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_ChefsToolT1");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_ChefsToolT2");//add results here
