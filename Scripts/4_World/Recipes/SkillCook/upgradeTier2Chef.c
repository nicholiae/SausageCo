class upgradeTier2Chef extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Chef Master";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_ChefsToolT2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_ChefsToolT3");//add results here
