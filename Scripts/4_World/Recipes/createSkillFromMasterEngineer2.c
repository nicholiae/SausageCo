class createSkillFromMasterEngineer2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Start Leatherworker Skill";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_EngineersToolT3");//you can insert multiple ingredients this way
