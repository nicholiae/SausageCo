class createSheetMetal3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "SheetMetal from gold";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_gold");//you can insert multiple ingredients this way
		...
		m_ResultSetQuantity[0] = 11;//-1 = do nothing
		...
		m_ResultSetQuantity[1] = 8;//-1 = do nothing
