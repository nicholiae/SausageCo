class createSheetMetal1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "SheetMetal from Copper";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_copper");//you can insert multiple ingredients this way
