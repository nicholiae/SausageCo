class createSheetMetal2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "SheetMetal from Silver";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageBar_silver");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_MechanicsToolT1");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageCo_MechanicsToolT2");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageCo_MechanicsToolT3");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageCo_MechanicsToolT4");//you can insert multiple ingredients this way
		...
		m_ResultSetQuantity[0] = 9;//-1 = do nothing
	...
	// result2
		AddResult("SausageCo_Experience_Mechanic");//add results here

		m_ResultSetFullQuantity[1] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[1] = 7;//-1 = do nothing
