class upgradeTier2Mechanic extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Mechanic Master";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Mechanic");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_MechanicsToolT3");//add results here
