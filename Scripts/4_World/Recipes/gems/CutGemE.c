class CutGemE extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Raw Emerald";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageGem_Emerald");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageGem_Emerald_Cut");//add results here
