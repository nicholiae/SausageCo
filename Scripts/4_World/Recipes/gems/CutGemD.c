class CutGemD extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Raw Diamond";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageGem_Diamond");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageGem_Diamond_Cut");//add results here
