class CutGemR extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Raw Ruby";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageGem_Ruby");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageGem_Ruby_Cut");//add results here
