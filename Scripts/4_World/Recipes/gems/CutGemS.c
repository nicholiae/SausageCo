class CutGemS extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Raw Saphire";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageGem_Saphire");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageGem_Saphire_Cut");//add results here
