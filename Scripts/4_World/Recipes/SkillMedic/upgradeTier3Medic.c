class upgradeTier3Medic extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Medic Mastery";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Medic");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_MedicsToolT3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_MedicsToolT4");//add results here
