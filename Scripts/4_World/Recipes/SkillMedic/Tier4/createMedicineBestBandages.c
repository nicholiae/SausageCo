class createMedicineBestBandages extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Best Bandages";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_MedicsToolT4");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SC_BestBandages");//add results here
