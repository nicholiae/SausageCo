class createMedicinePainkillerTablets extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create PainkillerTablets";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BasicCannabis");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PainkillerTablets");//add results here
		...
		//result2
		AddResult("SausageCo_Experience_Medic");//add results here
