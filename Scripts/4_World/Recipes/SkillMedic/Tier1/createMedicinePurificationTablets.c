class createMedicinePurificationTablets extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create PurificationTablets";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_MedicsToolT1");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("PurificationTablets");//add results here
