class upgradeTier2Medic extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Medic Master";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_MedicsToolT2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_MedicsToolT3");//add results here
