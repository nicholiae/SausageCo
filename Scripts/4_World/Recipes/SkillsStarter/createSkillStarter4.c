class createSkillStarter4 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Begin Leatherworkers Journey";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Starter");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_StartersTool");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_LeatherWorkersToolT1");//add results here
