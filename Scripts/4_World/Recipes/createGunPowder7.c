class createGunPowder7 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 500%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_Blood");//you can insert multiple ingredients this way
	...
	// result2
		...
		m_ResultSetQuantity[1] = 36;//-1 = do nothing
