class upgradeTier2Leather extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Leather Master";
		...
		m_MinQuantityIngredient[0] = 2000;//-1 = disable check
		...
		m_IngredientAddQuantity[0] = -2000;// 0 = do nothing
		...
		//result1
		AddResult("SausageCo_LeatherWorkersToolT3");//add results here
