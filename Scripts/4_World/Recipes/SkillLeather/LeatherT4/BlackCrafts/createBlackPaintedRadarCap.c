class createBlackPaintedRadarCap extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"RadarCap_Brown");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("RadarCap_Black");//add results here
