class createBlackPaintedShockpistol extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Shockpistol");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Shockpistol_Black");//add results here
