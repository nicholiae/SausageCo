class createBlackPaintedManSuit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"ManSuit_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ManSuit_Black");//add results here
