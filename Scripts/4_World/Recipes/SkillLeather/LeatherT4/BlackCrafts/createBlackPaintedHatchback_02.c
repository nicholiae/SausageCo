class createBlackPaintedHatchback_02 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_PaintBucket_Black");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_Vehicle_GunterBase_Kit");//you can insert multiple ingredients this way
		
		m_IngredientAddHealth[1] = 0;// 0 = do nothing
		m_IngredientSetHealth[1] = 0; // -1 = do nothing
		...
		//result1
		AddResult("SausageCo_Vehicle_GunterBlack_Kit");//add results here
