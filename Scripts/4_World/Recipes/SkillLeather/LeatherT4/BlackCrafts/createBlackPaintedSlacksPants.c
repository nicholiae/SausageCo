class createBlackPaintedSlacksPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"SlacksPants_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SlacksPants_Black");//add results here
