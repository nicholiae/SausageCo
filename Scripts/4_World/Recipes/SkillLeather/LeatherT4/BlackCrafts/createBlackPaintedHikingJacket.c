class createBlackPaintedHikingJacket extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"HikingJacket_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HikingJacket_Black");//add results here
