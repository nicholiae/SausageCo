class createBlackPaintedTacticalGloves extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"TacticalGloves_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TacticalGloves_Black");//add results here
