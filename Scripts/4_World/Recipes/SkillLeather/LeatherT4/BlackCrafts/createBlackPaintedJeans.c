class createBlackPaintedJeans extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Jeans_Grey");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Jeans_Black");//add results here
