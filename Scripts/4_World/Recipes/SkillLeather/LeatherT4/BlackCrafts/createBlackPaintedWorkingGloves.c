class createBlackPaintedWorkingGloves extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"WorkingGloves_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WorkingGloves_Black");//add results here
