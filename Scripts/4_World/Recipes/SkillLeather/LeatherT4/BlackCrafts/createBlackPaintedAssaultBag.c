class createBlackPaintedAssaultBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"AssaultBag_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AssaultBag_Black");//add results here
