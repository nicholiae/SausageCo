class createBlackPaintedWoolCoat extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"WoolCoat_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WoolCoat_Black");//add results here
