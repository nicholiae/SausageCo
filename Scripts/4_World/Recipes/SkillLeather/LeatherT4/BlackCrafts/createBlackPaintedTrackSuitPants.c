class createBlackPaintedTrackSuitPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"TrackSuitPants_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TrackSuitPants_Black");//add results here
