class createBlackPaintedFirefighterJacket extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"FirefighterJacket_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FirefighterJacket_Black");//add results here
