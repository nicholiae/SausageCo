class createBlackPaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create BlackColor Paint";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SC_CaninaBerry");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_PaintBucket_base");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_PaintBucket_Black");//add results here
