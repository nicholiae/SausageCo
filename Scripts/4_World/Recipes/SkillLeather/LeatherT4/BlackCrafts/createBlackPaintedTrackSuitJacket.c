class createBlackPaintedTrackSuitJacket extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"TrackSuitJacket_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TrackSuitJacket_Black");//add results here
