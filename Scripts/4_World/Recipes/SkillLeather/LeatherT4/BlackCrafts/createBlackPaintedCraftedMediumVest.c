class createBlackPaintedCraftedMediumVest extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedMediumVest");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumVest_black");//add results here
