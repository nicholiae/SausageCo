class createBlackPaintedHatchback_02_Hood extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Hatchback_02_Hood");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Hatchback_02_Hood_Black");//add results here
