class createBlackPaintedCowboyHat extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CowboyHat_Brown");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CowboyHat_black");//add results here
