class createBlackPaintedHatchback extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_Vehicle_ADA4x4Base_Kit");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_Vehicle_ADA4x4Black_Kit");//add results here
