class createBlackPaintedCivSedanHood extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CivSedanHood");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CivSedanHood_Black");//add results here
