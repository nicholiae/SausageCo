class createBlackPaintedCraftedSmallPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedSmallPants");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedSmallPants_black");//add results here
