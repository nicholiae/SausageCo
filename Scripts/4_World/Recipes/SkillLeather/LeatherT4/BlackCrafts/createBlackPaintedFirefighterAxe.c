class createBlackPaintedFirefighterAxe extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"FirefighterAxe_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FirefighterAxe_Black");//add results here
