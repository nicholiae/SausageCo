class createBlackPaintedCraftedMediumPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedMediumPants");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumPants_black");//add results here
