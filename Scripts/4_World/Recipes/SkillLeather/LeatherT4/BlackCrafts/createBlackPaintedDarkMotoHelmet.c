class createBlackPaintedDarkMotoHelmet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"DarkMotoHelmet_White");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DarkMotoHelmet_Black");//add results here
