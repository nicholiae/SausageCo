class createBlackPaintedCraftedLargePants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedLargePants");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargePants_black");//add results here
