class createBlackPaintedSneakers extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Sneakers_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Sneakers_Black");//add results here
