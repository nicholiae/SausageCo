class createBlackPaintedUKAssVest extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"UKAssVest_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("UKAssVest_Black");//add results here
