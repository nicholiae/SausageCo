class createBlackPaintedCraftedLargeBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedLargeBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargeBag_black");//add results here
