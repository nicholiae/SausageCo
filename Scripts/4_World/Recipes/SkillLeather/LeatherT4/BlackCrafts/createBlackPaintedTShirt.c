class createBlackPaintedTShirt extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"TShirt_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TShirt_Black");//add results here
