class createBlackPaintedJoggingShoes extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"JoggingShoes_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("JoggingShoes_Black");//add results here
