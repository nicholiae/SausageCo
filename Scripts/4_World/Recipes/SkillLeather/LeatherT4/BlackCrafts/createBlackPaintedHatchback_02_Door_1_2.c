class createBlackPaintedHatchback_02_Door_1_2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Hatchback_02_Door_1_2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Hatchback_02_Door_1_2_Black");//add results here
