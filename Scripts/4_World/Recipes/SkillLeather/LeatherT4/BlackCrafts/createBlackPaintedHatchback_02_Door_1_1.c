class createBlackPaintedHatchback_02_Door_1_1 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Hatchback_02_Door_1_1");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Hatchback_02_Door_1_1_Black");//add results here
