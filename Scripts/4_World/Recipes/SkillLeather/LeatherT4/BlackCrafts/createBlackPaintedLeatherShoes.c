class createBlackPaintedLeatherShoes extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"LeatherShoes_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("LeatherShoes_Black");//add results here
