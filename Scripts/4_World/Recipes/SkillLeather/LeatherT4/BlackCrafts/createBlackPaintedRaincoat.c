class createBlackPaintedRaincoat extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Raincoat_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Raincoat_Black");//add results here
