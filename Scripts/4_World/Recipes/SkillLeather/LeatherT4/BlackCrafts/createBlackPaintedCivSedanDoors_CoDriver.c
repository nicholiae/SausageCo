class createBlackPaintedCivSedanDoors_CoDriver extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CivSedanDoors_CoDriver");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CivSedanDoors_CoDriver_Black");//add results here
