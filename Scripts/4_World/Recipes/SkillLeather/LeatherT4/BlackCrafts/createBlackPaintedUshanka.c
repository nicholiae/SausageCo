class createBlackPaintedUshanka extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Ushanka");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Ushanka_Black");//add results here
