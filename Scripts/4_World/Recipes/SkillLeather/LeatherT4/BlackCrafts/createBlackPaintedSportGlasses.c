class createBlackPaintedSportGlasses extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"SportGlasses_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SportGlasses_Black");//add results here
