class createBlackPaintedFireFighterPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"FirefightersPants_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FirefighterPants_Black");//add results here
