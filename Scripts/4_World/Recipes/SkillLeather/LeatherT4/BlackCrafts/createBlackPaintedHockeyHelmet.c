class createBlackPaintedHockeyHelmet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"HockeyHelmet_White");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HockeyHelmet_Black");//add results here
