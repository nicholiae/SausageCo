class createBlackPaintedCraftedSmallBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedSmallBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedSmallBag_black");//add results here
