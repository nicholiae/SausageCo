class createBlackPaintedDerringer extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Derringer");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Derringer_Black");//add results here
