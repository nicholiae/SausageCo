class createBlackPaintedWellies extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Wellies_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Wellies_Black");//add results here
