class createBlackPaintedBreechesPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Breeches_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Breeches_Black");//add results here
