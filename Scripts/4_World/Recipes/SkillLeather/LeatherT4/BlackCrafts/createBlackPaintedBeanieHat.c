class createBlackPaintedBeanieHat extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"BeanieHat_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BeanieHat_Black");//add results here
