class createBlackPaintedBalaclava extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"BalaclavaMask_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BalaclavaMask_Black");//add results here
