class createBlackPaintedAK_WoodHndgrd extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"AK_WoodHndgrd");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AK_WoodHndgrd_Black");//add results here
