class createBlackPaintedCraftedMediumShirt extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedMediumShirt");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumShirt_black");//add results here
