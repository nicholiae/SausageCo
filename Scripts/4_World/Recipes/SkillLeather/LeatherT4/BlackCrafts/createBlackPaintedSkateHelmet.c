class createBlackPaintedSkateHelmet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"SkateHelmet_Gray");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SkateHelmet_Black");//add results here
