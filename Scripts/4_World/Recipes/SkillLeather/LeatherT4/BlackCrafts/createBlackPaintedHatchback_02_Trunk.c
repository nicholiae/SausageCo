class createBlackPaintedHatchback_02_Trunk extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Hatchback_02_Trunk");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Hatchback_02_Trunk_Black");//add results here
