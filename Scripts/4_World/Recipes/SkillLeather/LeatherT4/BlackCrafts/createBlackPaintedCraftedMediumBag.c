class createBlackPaintedCraftedMediumBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedMediumBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumBag_black");//add results here
