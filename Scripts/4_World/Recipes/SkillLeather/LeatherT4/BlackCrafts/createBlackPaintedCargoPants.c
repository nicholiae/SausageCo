class createBlackPaintedCargoPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CargoPants_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CargoPants_Black");//add results here
