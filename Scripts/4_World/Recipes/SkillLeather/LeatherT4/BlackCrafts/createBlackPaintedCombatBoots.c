class createBlackPaintedCombatBoots extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CombatBoots_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CombatBoots_Black");//add results here
