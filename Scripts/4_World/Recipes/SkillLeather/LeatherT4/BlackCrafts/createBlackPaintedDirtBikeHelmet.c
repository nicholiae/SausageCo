class createBlackPaintedDirtBikeHelmet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"DirtBikeHelmet_Chernarus");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DirtBikeHelmet_Black");//add results here
