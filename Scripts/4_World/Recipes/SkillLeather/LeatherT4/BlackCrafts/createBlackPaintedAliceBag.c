class createBlackPaintedAliceBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"AliceBag_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("AliceBag_Black");//add results here
