class createBlackPaintedCraftedSmallVest extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedSmallVest");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedSmallVest_black");//add results here
