class createBlackPaintedBoonieHat extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"BoonieHat_Blue");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BoonieHat_Black");//add results here
