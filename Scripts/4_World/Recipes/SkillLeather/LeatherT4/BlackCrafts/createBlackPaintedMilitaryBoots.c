class createBlackPaintedMilitaryBoots extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"MilitaryBoots_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("MilitaryBoots_Black");//add results here
