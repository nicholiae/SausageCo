class createBlackPaintedZmijovkaCap extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"ZmijovkaCap_Brown");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("ZmijovkaCap_Black");//add results here
