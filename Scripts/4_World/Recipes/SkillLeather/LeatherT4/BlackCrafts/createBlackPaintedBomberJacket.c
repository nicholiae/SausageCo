class createBlackPaintedBomberJacket extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"BomberJacket_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BomberJacket_Black");//add results here
