class createBlackPaintedHikingBoots extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"HikingBoots_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HikingBoots_Black");//add results here
