class createBlackPaintedBandana extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Bandana_Yellow");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Bandana_BlackPattern");//add results here
