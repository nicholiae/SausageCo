class createBlackPaintedHeadtorch extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Headtorch");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Headtorch_Black");//add results here
