class createBlackPaintedWomanSuit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"WomanSuit_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("WomanSuit_Black");//add results here
