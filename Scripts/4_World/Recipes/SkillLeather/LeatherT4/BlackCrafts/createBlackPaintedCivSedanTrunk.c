class createBlackPaintedCivSedanTrunk extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CivSedanTrunk");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CivSedanTrunk_Black");//add results here
