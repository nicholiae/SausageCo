class createBlackPaintedHikingBootsLow extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"HikingBootsLow_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HikingBootsLow_Black");//add results here
