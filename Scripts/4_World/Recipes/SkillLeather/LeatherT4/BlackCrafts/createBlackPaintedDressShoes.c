class createBlackPaintedDressShoes extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"DressShoes_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DressShoes_Black");//add results here
