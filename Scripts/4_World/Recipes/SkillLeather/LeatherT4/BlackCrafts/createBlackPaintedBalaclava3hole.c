class createBlackPaintedBalaclava3hole extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Balaclava3Holes_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Balaclava3Holes_Black");//add results here
