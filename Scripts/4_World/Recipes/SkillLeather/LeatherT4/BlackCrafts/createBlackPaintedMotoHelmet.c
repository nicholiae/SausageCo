class createBlackPaintedMotoHelmet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"MotoHelmet_White");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("MotoHelmet_Black");//add results here
