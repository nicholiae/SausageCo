class createBlackPaintedLeatherBelt extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"LeatherBelt_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("LeatherBelt_Black");//add results here
