class createBlackPaintedBaseballCapCMMG extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"BaseballCap_Beige");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("BaseballCap__CMMG_Black");//add results here
