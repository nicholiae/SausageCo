class createBlackPaintedCraftedLargeVest extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedLargeVest");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargeVest_black");//add results here
