class createBlackPaintedCivSedanDoors_BackRight extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CivSedanDoors_BackRight");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CivSedanDoors_BackRight_Black");//add results here
