class createBlackPaintedCivSedanDoors_BackLeft extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CivSedanDoors_BackLeft");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CivSedanDoors_BackLeft_Black");//add results here
