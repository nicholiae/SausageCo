class createBlackPaintedCraftedSmallShirt extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"CraftedSmallShirt");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedSmallShirt_black");//add results here
