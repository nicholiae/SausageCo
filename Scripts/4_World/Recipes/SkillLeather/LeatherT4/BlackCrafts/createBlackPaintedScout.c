class createBlackPaintedScout extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Black";
		...
		//ingredient 2
		InsertIngredient(1,"Scout");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Scout_Black");//add results here
