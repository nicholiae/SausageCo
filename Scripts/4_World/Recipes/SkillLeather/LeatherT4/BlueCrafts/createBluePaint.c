class createBluePaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create BlueColor Paint";
		...
		InsertIngredient(0,"SC_SambucusBerry");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_PaintBucket_Blue");//add results here
