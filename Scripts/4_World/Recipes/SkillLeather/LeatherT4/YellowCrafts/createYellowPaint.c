class createYellowPaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create YellowColor Paint";
		...
		InsertIngredient(0,"SC_Pear");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_PaintBucket_Yellow");//add results here
