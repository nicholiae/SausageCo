class createDimanGreenMonsterBoots extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create DimanMonster Boots";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"MilitaryBoots_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DimanBoots_GreenMonster");//add results here
