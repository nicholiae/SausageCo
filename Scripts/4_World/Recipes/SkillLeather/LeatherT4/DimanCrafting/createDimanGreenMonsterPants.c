class createDimanGreenMonsterPants extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create DimanMonster Pants";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Jeans_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DimanPants_GreenMonster");//add results here
