class createDimanGreenMonsterGloves extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create DimanMonster Gloves";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TacticalGloves_ColorBase");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_PaintBucket_DimanCamo");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DimanGloves_GreenMonster");//add results here
