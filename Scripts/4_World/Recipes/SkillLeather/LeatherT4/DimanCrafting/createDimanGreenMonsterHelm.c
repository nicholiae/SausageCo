class createDimanGreenMonsterHelm extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create DimanMonster Helm";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Mich2001Helmet");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DimanHelmet_GreenMonster");//add results here
