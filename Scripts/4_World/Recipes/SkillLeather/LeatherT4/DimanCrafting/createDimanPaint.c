class createDimanPaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create DimanCamo Paint";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.75;//animation length in relative time units
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Leather");//you can insert multiple ingredients this way
		
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = -30;// 0 = do nothing
		...
		//result1
		AddResult("SausageCo_PaintBucket_DimanCamo");//add results here
