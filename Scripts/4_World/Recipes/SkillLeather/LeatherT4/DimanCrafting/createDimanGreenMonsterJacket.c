class createDimanGreenMonsterJacket extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create DimanMonster Jacket";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"M65Jacket_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("DimanJacket_GreenMonster");//add results here
