class createPurplePaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create PurpleColor Paint";
		...
		InsertIngredient(0,"SC_Plum");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_PaintBucket_Purple");//add results here
