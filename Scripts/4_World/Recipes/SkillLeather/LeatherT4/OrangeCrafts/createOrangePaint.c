class createOrangePaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create OrangeColor Paint";
		...
		InsertIngredient(0,"SC_Pumpkin");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_PaintBucket_Orange");//add results here
