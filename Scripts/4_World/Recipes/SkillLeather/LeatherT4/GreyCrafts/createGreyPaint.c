class createGreyPaint extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create GreyColor Paint";
		...
		InsertIngredient(0,"SC_Potato");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_PaintBucket_Grey");//add results here
