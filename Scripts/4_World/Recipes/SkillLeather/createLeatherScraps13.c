class createLeatherScraps13 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create LeatherScraps";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Clothing_Base");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_LeatherWorkersToolT1");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageCo_LeatherWorkersToolT2");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageCo_LeatherWorkersToolT3");//you can insert multiple ingredients this way
		InsertIngredient(1,"SausageCo_LeatherWorkersToolT4");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCoLeatherScraps");//add results here
	...
	//result2
		AddResult("SausageCo_Experience_Leather");//add results here

		m_ResultSetFullQuantity[1] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[1] = 50;//-1 = do nothing
