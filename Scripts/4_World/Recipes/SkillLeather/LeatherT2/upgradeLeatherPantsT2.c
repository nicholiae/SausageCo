class upgradeLeatherPantsT2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade Leather Pants";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedSmallPants");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumPants");//add results here
