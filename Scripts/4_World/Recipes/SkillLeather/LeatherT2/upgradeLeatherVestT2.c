class upgradeLeatherVestT2 extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedSmallVest");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumVest");//add results here
