class upgradeLeatherShirtT2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade Leather Shirt";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedSmallShirt");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"LeatherUpgradeKit_T2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumShirt");//add results here
