class upgradeLeatherBagT2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade Leather Bag";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedSmallBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedMediumBag");//add results here
