class createLeatherProtectiveCaseT2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create ProtectiveCase";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCoLeatherScraps");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SmallProtectorCase");//add results here
