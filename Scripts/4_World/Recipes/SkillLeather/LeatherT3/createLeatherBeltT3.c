class createLeatherBeltT3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Modular Belt";
		...
		//result1
		AddResult("SausageCo_ModularBeltSystem");//add results here
	...
	//result2
		...
		m_ResultSetQuantity[1] = 9;//-1 = do nothing
