class upgradeLeatherVestT3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "upgrade Leather Vest";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedMediumVest");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargeVest");//add results here
