class upgradeLeatherPantsT3 extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedMediumPants");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargePants");//add results here
