class upgradeLeatherShirtT3 extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedMediumShirt");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"LeatherUpgradeKit_T3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargeShirt");//add results here
