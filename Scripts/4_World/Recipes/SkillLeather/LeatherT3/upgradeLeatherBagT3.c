class upgradeLeatherBagT3 extends RecipeBase
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"CraftedMediumBag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("CraftedLargeBag");//add results here
