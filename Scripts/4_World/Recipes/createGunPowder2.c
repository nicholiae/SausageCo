class createGunPowder2 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 75%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_silver");//you can insert multiple ingredients this way
