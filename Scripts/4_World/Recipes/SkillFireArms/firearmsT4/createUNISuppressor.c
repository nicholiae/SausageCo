class createUNISuppressor extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Universal Suppressor";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FirearmsToolT4");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_UniSilencer");//add results here
