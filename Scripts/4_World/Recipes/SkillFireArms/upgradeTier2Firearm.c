class upgradeTier2Firearm extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Firearms Master";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FirearmsToolT2");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FirearmsToolT3");//add results here
