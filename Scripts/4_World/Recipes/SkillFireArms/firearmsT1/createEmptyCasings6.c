class createEmptyCasings6 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "EmptyCasings from Presem";
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_FirearmsToolT1");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_BulletCasing");//add results here

		m_ResultSetFullQuantity[0] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[0] = 175;//-1 = do nothing
