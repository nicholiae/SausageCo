class createAmmo12gaRubberSlug extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create 12gaRubberSlug Ammo";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_BulletCasing_Filled");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Ammo_12gaRubberSlug");//add results here
