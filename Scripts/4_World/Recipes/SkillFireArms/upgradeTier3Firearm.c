class upgradeTier3Firearm extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Upgrade to Firearms Mastery";
		...
		m_MinQuantityIngredient[0] = 3000;//-1 = disable check
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_Experience_Firearm");//you can insert multiple ingredients this way
		
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = -3000;// 0 = do nothing
		m_IngredientDestroy[0] = false;//true = destroy, false = do nothing
		m_IngredientUseSoftSkills[0] = false;// set 'true' to allow modification of the values by softskills on this ingredient
		
		//ingredient 2
		InsertIngredient(1,"SausageCo_FirearmsToolT3");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_FirearmsToolT4");//add results here
	...
	// result2
		AddResult("SausageCo_WeaponMold_pistolframe");//add results here
	...
	// result3
		AddResult("SausageCo_WeaponMold_pistolbarrel");//add results here
	...
	// result4
		AddResult("SausageCo_WeaponMold_arframe");//add results here
	...
	// result5
		AddResult("SausageCo_WeaponMold_arbarrel");//add results here
	...
	// result6
		AddResult("SausageCo_WeaponMold_heavyarframe");//add results here

		m_ResultSetFullQuantity[5] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[5] = -1;//-1 = do nothing
	...
	// result7
		AddResult("SausageCo_WeaponMold_heavyarbarrel");//add results here

		m_ResultSetFullQuantity[6] = false;//true = set full quantity, false = do nothing
		m_ResultSetQuantity[6] = -1;//-1 = do nothing
