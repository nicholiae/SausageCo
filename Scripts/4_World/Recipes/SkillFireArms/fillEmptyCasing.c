class fillEmptyCasing extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill Emtpy Casing";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageCo_GunPowder");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SausageCo_BulletCasing");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SausageCo_BulletCasing_Filled");//add results here
