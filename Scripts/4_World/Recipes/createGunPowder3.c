class createGunPowder3 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gunpowder 100%";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SausageNugget_gold");//you can insert multiple ingredients this way
