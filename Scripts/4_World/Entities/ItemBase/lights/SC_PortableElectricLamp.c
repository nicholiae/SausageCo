class SC_PortableElectricLamp extends ItemBase
{
	SC_PortableElectricLampLight	m_Light;
	...
	override void OnWorkStart()
	{
		...
		{
			m_Light = SC_PortableElectricLampLight.Cast( ScriptedLightBase.CreateLight( SC_PortableElectricLampLight, "0 0 0") );
