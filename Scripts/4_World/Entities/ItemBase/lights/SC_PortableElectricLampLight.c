class SC_PortableElectricLampLight extends PointLightBase
{
	static float m_TorchRadius = 50;
	static float m_TorchBrightness = 8.0;
	
	void SC_PortableElectricLampLight()
	{
