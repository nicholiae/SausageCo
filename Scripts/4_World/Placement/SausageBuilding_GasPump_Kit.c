class SausageBuilding_GasPump_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								SausageBuilding_GasPump_Kit1;	
	...
	override void OnPlacementComplete(Man player, vector position = "0 0.75 0", vector orientation = "0 0 0")
	{
		super.OnPlacementComplete(player, position, orientation);
			...
			if (GetGame().IsServer())
			{
				EntityAI kitItem = EntityAI.Cast(GetGame().CreateObjectEx("SausageBuilding_GasPump", position, ECE_PLACE_ON_SURFACE));
...
class SausageBuilding_GasPump_Holo extends ItemBase
{
...
class SausageBuilding_GasPump extends ItemBase
{ 	
