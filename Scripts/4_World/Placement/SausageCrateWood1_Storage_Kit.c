class SausageCrateWood1_Storage_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								SausageCrateWood1_Storage_Kit1;	
	...
	override void OnPlacementComplete(Man player, vector position = "0 0.3 0", vector orientation = "0 0 0")
	{
		super.OnPlacementComplete(player, position, orientation);
			...
			if (GetGame().IsServer())
			{
				EntityAI kitItem = EntityAI.Cast(GetGame().CreateObjectEx("SausageCrateWood1_Storage", position, ECE_PLACE_ON_SURFACE));
				vector positionChange = "0 0.3 0";
...
class SausageCrateWood1_Storage_Holo extends ItemBase
{
...
class SausageCrateWood1_Storage extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
