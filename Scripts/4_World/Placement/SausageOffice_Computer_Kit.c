class SausageOffice_Computer_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								SausageOffice_Computer_Kit1;	
	...
	override void OnPlacementComplete(Man player, vector position = "0 0 0", vector orientation = "0 0 0")
	{
		super.OnPlacementComplete(player, position, orientation);
			...
			if (GetGame().IsServer())
			{
				EntityAI kitItem = EntityAI.Cast(GetGame().CreateObjectEx("SausageOffice_Computer", position, ECE_PLACE_ON_SURFACE));
...
class SausageOffice_Computer_Holo extends ItemBase
{
...
class SausageOffice_Computer extends ItemBase
{
	float						m_Fuel;
	...
	override void SetActions()
	{
		...
		AddAction(ActionTurnOnComputer);
		AddAction(ActionTurnOffComputer);
	}
