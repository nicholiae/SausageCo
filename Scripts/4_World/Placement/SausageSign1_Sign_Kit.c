class SausageBuilding_Sign1_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								SausageBuilding_Sign1_Kit1;	
	...
	override void OnPlacementComplete(Man player, vector position = "0 2 0", vector orientation = "0 0 0")
	{
		super.OnPlacementComplete(player, position, orientation);
			...
			if (GetGame().IsServer())
			{
				EntityAI kitItem = EntityAI.Cast(GetGame().CreateObjectEx("SausageBuilding_Sign1", position, ECE_PLACE_ON_SURFACE));
				vector positionChange = "0 2 0";
...
class SausageBuilding_Sign1_Holo extends ItemBase
{
...
class SausageBuilding_Sign1 extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
