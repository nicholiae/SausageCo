class SausageKitchen_Fridge_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								SausageKitchen_Fridge_Kit1;	
	...
	override void OnPlacementComplete(Man player, vector position = "0 0 0", vector orientation = "0 0 0")
	{
		super.OnPlacementComplete(player, position, orientation);
			...
			if (GetGame().IsServer())
			{
				EntityAI kitItem = EntityAI.Cast(GetGame().CreateObjectEx("SausageKitchen_Fridge", position, ECE_PLACE_ON_SURFACE));
...
class SausageKitchen_Fridge_Holo extends ItemBase
{
...
class SausageKitchen_Fridge extends SC_Fridge_Base
{
	void Base_Destroy()
	{
		//delete object
