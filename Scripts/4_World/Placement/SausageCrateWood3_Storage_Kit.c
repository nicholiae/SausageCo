class SausageCrateWood3_Storage_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								SausageCrateWood3_Storage_Kit1;	
	...
	override void OnPlacementComplete(Man player, vector position = "0 1 0", vector orientation = "0 0 0")
	{
		super.OnPlacementComplete(player, position, orientation);
			...
			if (GetGame().IsServer())
			{
				EntityAI kitItem = EntityAI.Cast(GetGame().CreateObjectEx("SausageCrateWood3_Storage", position, ECE_PLACE_ON_SURFACE));
				vector positionChange = "0 1 0";
...
class SausageCrateWood3_Storage_Holo extends ItemBase
{
...
class SausageCrateWood3_Storage extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
