class ActionDeploySCObject extends ActionDeployObject
{
    override void OnEndServer(ActionData action_data)
    {
        ...
        // First check if the item is one of our kits
        bool isOurKit = false;
        ...
        {
            // If it's not our kit, let the parent class handle it
