...
// {
	// const float FISHING_SUCCESS 		= 0.452;
	// const float FISHING_BAIT_LOSS 		= 0.011;
	// const float FISHING_HOOK_LOSS 		= 0.009;
	// const float FISHING_DAMAGE 			= 2.75;
	// const float FISHING_GARBAGE_CHANCE 	= 0.3;
...
// {
	...
	// ref array<string> 	m_JunkTypes = {"Wellies_Black","Wellies_Brown","Wellies_Green","Wellies_Grey","Pot","FryingPan","NBCGlovesGray","NBCHoodGray","NBCPantsGray","NBCBootsGray","NBCJacketGray","GasMask"};
	...
	// {
		...
		// {
			...
			// if (Math.RandomFloatInclusive(0.0,1.0) > m_ActionDataFishing.FISHING_HOOK_LOSS) //no loss of worm only
			// {
				// if (!m_ActionDataFishing.IsBaitEmptyHook())
				// {
					// m_ActionDataFishing.m_Bait.AddHealth(-m_ActionDataFishing.FISHING_DAMAGE);
