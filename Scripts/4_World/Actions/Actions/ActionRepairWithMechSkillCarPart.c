class ActionRepairWithMechSkillCarPartCB : ActionRepairCarPartCB
{
...
class ActionRepairWithMechSkillCarPart : ActionRepairCarPart 
{
	void ActionRepairWithMechSkillCarPart()
	{
		m_CallbackClass 	= ActionRepairWithMechSkillCarPartCB;
