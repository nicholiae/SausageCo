class ActionRepairWithMechSkillCarEngineCB : ActionRepairCarEngineCB
{
...
class ActionRepairWithMechSkillCarEngine: ActionRepairCarEngine
{
	void ActionRepairWithMechSkillCarEngine()
	{
		m_CallbackClass 	= ActionRepairWithMechSkillCarEngineCB;
