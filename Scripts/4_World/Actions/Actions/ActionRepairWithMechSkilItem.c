class ActionRepairWithMechSkilItemCB : ActionContinuousBaseCB
{
...
class ActionRepairWithMechSkilItem : ActionContinuousBase 
{
	void ActionRepairWithMechSkilItem()
	{
		m_CallbackClass 	= ActionRepairWithMechSkilItemCB;
	...
	override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
	{
		...
		return moduleRepairing && moduleRepairing.CanRepair(item, target.GetObject());
	}
