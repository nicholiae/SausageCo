class ActionRepairWithMechSkillCarChassisCB : ActionRepairCarChassisCB
{
...
class ActionRepairWithMechSkillCarChassis : ActionRepairCarChassis
{
	void ActionRepairWithMechSkillCarChassis()
	{
		m_CallbackClass 	= ActionRepairWithMechSkillCarChassisCB;
