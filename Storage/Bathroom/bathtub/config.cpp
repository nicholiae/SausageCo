...
class CfgVehicles
{
	...
	{};
	class SausageBathroom_Bath: Barrel_ColorBase
	{
		scope=2;
		displayName="Sausage Bathroom Tub";
		...
		varQuantityInit=800000;
		varQuantityMin=0;
		varQuantityMax=800000;
		absorbency=0.1;
		class Cargo
		{
	...
	class SausageBathroom_Bath_Kit_Holo: Container_Base
	{
		scope = 0;
		displayName = "Bathroom Tub HOLO";
		model="\DZ\structures\furniture\bathroom\bath\bath.p3d";
	};
};