...
class CfgVehicles
{
	...
	class SC_Kit: Container_Base
	{
		...
		model="\SausageFramework\data\kitbox\kitbox.p3d";
		itemsCargoSize[]={0,0};
		itemSize[]={6,4};
		carveNavmesh=1;
		canBeDigged=0;
		...
		{
			"SausageFramework\data\kitbox\kitbox_co.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"SausageFramework\data\kitbox\kitbox.rvmat"
		};
		class DamageSystem
		{
			class GlobalHealth
	...
	class SC_Storage_Base: Container_Base
	{
		scope=0;
		itemSize[]={10,15};
	...
	class SC_InventoryStorage_Base: Container_Base
	{
		scope=0;
		itemSize[]={10,15};
		overrideDrawArea="8.0";
	...
	class SC_Openable_Base: SC_Item
	{
	...
	class SC_Openable_Placeable_Base: SC_Storage_Base
	{
		class AnimationSources
		{
			class Doors1
	...
	class SC_Foldable_Item: Container_Base
	{
